...
const TABLES: Record<string, string[]> = {
  ...
  break_logs: ['id', 'user_id', 'date', 'start_time', 'duration', 'created_at'],
  skill_progress: ['id', 'user_id', 'skill_id', 'skill_name', 'xp', 'level', 'category', 'created_at', 'updated_at'],
  skill_sessions: ['id', 'user_id', 'date', 'skill_id', 'skill_name', 'duration_min', 'created_at'],
  income_logs: ['id', 'user_id', 'date', 'amount', 'source', 'created_at'],
